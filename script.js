...
function showSearchStatus(statusText) {
  ...
  loaderDiv.innerHTML = `
  <svg class="pl pixelated-compass" viewBox="0 0 160 160" width="32" height="32" xmlns="http://www.w3.org/2000/svg" style="image-rendering: pixelated; shape-rendering: crispEdges;">
      <defs>
